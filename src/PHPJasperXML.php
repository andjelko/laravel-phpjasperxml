...
\p{Yi}*/
    ...
    public function element_staticText($data) {
        ...
        $border=0;
        $fontsize=10;
        $font= $this->fontfamily;//"SansSerif";
        $fontstyle="";
...
//        $b=$data->subreportParameter;
    ...
    public function transferDBtoArray($host='mysql',$user='user',$password='pass',$db_or_dsn_name='default',$cndriver="mysql") {
        $this->m=0;
...
//                    if(!$this->newPageGroup) {
        ...
        if($filename=="")
         ...
         $this->pdf->SetFont($this->fontfamily, '', 18);
